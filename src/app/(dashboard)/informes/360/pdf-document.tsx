  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        <Text style={styles.titulo}>Informe de Evaluación 360° Integrado</Text>
        ...
        <View style={styles.seccion}>
          <Text style={styles.seccionTitulo}>Hacer — detalle por evaluador</Text>
          {hacer.length === 0 ? (
        ...
        <View style={styles.seccion}>
          <Text style={styles.seccionTitulo}>Deber — detalle por evaluador</Text>
          {deber.length === 0 ? (
            <Text style={styles.label}>Sin respuestas registradas.</Text>
          ) : (
            deber.map((d) => (
